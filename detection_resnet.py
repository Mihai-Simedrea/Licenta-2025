...
from data_processing import RotationHandler, PaddingHandler, ResizeHandler, NormalizeHandler, BinaryMaskHandler
...
def parse_args():
    parser = argparse.ArgumentParser(description="Train Faster R-CNN for Breast Cancer Detection")
    parser.add_argument("--epochs", type=int, default=10, help="Number of training epochs")
    parser.add_argument("--batch-size", type=int, default=2, help="Batch size")
    parser.add_argument("--learning-rate", type=float, default=0.005, help="Learning rate")
    parser.add_argument("--pipeline", nargs="+", default=["ResizeHandler"], help="Preprocessors to apply")
    parser.add_argument("--checkpoint", type=str, default="detection_resnet.pth", help="Output checkpoint filename")
